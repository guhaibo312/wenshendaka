...
- (void)didSelectAsset:(ALAsset *)asset
{
    ...
    if (vc.TJWdelegate!=nil&&[vc.TJWdelegate respondsToSelector:@selector(assetPickerController:didSelectAsset:)])
        [vc.TJWdelegate assetPickerController:vc didSelectAsset:asset];
...
- (void)didDeselectAsset:(ALAsset *)asset
{
    ...
    if (vc.TJWdelegate!=nil&&[vc.TJWdelegate respondsToSelector:@selector(assetPickerController:didDeselectAsset:)])
        [vc.TJWdelegate assetPickerController:vc didDeselectAsset:asset];
