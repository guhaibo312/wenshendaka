...
- (void)dismissWithStatus:(NSString*)string style:(SVProgressHUDStyle)style afterDelay:(NSTimeInterval)seconds;
...
+ (void)showSuccessWithStatus:(NSString *)string {
    [SVProgressHUD showSuccessWithStatus:string duration: 1.5];
}
...
+ (void)showCoinsWithStatus:(NSString *)string {
    [SVProgressHUD show];
    [[SVProgressHUD sharedView] dismissWithStatus:string style:kSVProgressCoin afterDelay:2];
}
...
+ (void)dismissWithSuccess:(NSString *)successString afterDelay:(NSTimeInterval)seconds {
    [[SVProgressHUD sharedView] dismissWithStatus:successString style:kSVProgressSuccess afterDelay:seconds];
}
...
+ (void)dismissWithError:(NSString *)errorString afterDelay:(NSTimeInterval)seconds {
    [[SVProgressHUD sharedView] dismissWithStatus:errorString style: kSVProgressError afterDelay:seconds];
}
...
- (void)dismissWithStatus:(NSString*)string error:(BOOL)error {
//	[self dismissWithStstus:string error:error afterDelay:0.9];
    if (error) {
        [self dismissWithStatus:string style:kSVProgressError afterDelay:0.9];
    } else {
        [self dismissWithStatus:string style:kSVProgressSuccess afterDelay:0.9];
    }
}
