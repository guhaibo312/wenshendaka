//
//  ImageFeedInfoDetailViewController.m
//  Bshopkeeper
//
...
@interface ImageFeedInfoDetailViewController ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,UIActionSheetDelegate,JWSharedManagerDelegate>
{
    UITableView *detailTable;
    ImageFeedHeadView *detailTableHead;
...
@implementation ImageFeedInfoDetailViewController
...
- (void)layoutSubViews
{
    ...
    detailTableHead = [[ImageFeedHeadView alloc]initWithSquareItem:_dataSourceItem ownerController:self];
